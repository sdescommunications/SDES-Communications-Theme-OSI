...
<head>
	...
	<script>
		...
		})(window, document, 'script', 'dataLayer', 'GTM-KD9QPBB');
	</script>
	<!-- End Google Tag Manager -->
	<!--- OSI Web's Google Tag Analytics -->
	<!-- Global site tag (gtag.js) - Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-147457642-2"></script>
	<script>
	...
	<script type="text/javascript" id="ucfhb-script" src="//universityheader.ucf.edu/bar/js/university-header.js">
	</script>
...
<body>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KD9QPBB" height="0" width="0"
	...
	<header>
				...
				<section class="site-title">
					<article>
						...
						<span class="site-subtitle float-left hidden-md-down">
							<a
								href="<?= get_option("main_site_url", '') ? get_option("main_site_url") : '//www.sdes.ucf.edu' ?>">
								<?= html_entity_decode(get_bloginfo('description')) ?>
							</a>
						</span>
					</article>
					<aside class="text-lg-right">
						<a class="translate" href="http://it.sdes.ucf.edu/translate/" data-toggle="tooltip"
							data-placement="right" title="Translate This Page!"><i class="fa fa-globe"></i></a>
					</aside>
				</section>
			</div>
		...
		<div class="header-break hidden-md-down">
			...
			<img src="<?= (get_option('breaker_id', '')) ? get_option('breaker_id', '') : get_stylesheet_directory_uri() . '/images/breaker.jpg' ?>"
				class="img-fluid" />
		</div>
